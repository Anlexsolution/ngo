...
<body>
    ...
    <div class="authentication-wrapper authentication-cover">
        <!-- Logo -->
        <img src="../../assets/img/logo.png" alt="" height="60" width="80"
        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-flex col-12 col-lg-4 align-items-center authentication-bg p-sm-12 p-6">
                ...
                <div class="w-px-400 mx-auto mt-12 pt-5">
                    <h4 class="mb-1">Welcome to SWOAD! 👋</h4>
                    <p class="mb-6">Please sign-in to your account and start the adventure</p>

                    <div class="mb-6">
                        <label for="email" class="form-label">NIC Number</label>
                        <input type="text" class="form-control" id="nicNumber" name="nicNumber"
                            placeholder="Enter NIC Number" autofocus />
                    </div>
                    ...
                    <button class="btn btn-primary d-grid w-100" id="btnSignInMember">Sign in</button>
    ...
    <script>
        console.log("Site key:", "6Lelmq4qAAAAABsHLBvzTM0DuKyztADhuWv9UJoJ");
    </script>
