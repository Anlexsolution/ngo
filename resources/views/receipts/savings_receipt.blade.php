        ...
        <div style="font-family: Arial, sans-serif; text-align: center;">
            <div style=" margin: auto; border: 1px solid #000; padding: 10px;">
                ...
                <div style="text-align: left; margin-top: 10px;">
                    <strong>Date:</strong> {{$getData->created_at}}<br>
                </div>
                <div style="text-align: left; margin-top: 10px;">
                ...
                <div style="text-align: left; margin-top: 10px;">
                    ...
                    <strong>Payment:</strong> Rs. {{number_format($getData->amount, 2)}}<br>
                    <strong>Total Saving:</strong> Rs. {{number_format($getData->balance, 2)}}
                </div>
