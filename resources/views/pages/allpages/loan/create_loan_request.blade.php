                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="row mt-3">
                            ...
                            @endphp
                            <input type="text" id="txtLoanPurpose" value="{{ $getMainCatId }}" hidden>
                            <input type="text" id="txtLoanPurposeSub" value="{{ $getSubCatId }}" hidden>
                            <input type="text" id="txtloanAmount" value="{{ $getAmount }}" hidden>
                            <div class="col-6">
                                    ...
                                    <select class="selectize" id="txtSelectLoanApprovalSet">
                                        @foreach ($getLoanApproveSetData as $App)
                                            <option value="{{ $App->id }}">{{ $App->name }} (
                                                {{ number_format($App->minimum, 2) }} -
                                                {{ number_format($App->maximum, 2) }} ) approve -
                                                {{ $App->howManyApproval }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-4 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="txtPricipal" readonly>
                            ...
                            <div class="col-4 mt-2">
                                <div class="form-group">
                                    ...
                                    @endphp
                                    <input type="date" class="form-control" id="txtExpectedFirstRepaymentDate"
                                        value="{{ $finalDate }}">
                                </div>
                            </div>
                            <div class="col-12 mt-2">
                            ...
                            <div class="row">
                                @foreach ($getLoanDocData as $data)
                                    <div class="col-md-4 mb-2">
                                        <label>
                                            <input type="checkbox" name="loan_docs[]" class="loan-checkbox"
                                                value="{{$data['name']}}">
                                          {{$data['name']}}
                                        </label>
                                    </div>
                            ...
                            <input type="text" id="loanReqId" hidden value="{{ $getEncId }}">
