            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header text-uppercase custom-header bg-primary text-bg-info fw-bold">
                        <div class="col-6">
                            <i class="menu-icon ti ti-users-group"></i>Loan Report
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row mt-3">
                        ...
                        <a href="{{ route('view_pdf_loan_report') }}" class="mt-3" target="_blank">
                            ...
                            <tbody>
                                ...
                                @foreach ($getLoanData as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @foreach ($getLoanPurposeData as $LoanPur)
                                            @if ($LoanPur->id == $data->loanPurpose)
                                            {{ $LoanPur->name }}
                                            @endif
                                            @endforeach
                                        </td>
