                ...
                <div class="col-12 mb-4">
                    ...
                    <select class="selectize" id="txtUserType">
                        @foreach ($getUserRole as $getUserRole)
                            <option value="{{ $getUserRole->roleName }}">{{ $getUserRole->roleName }}</option>
                        @endforeach
                    </select>
                </div>
                <input type="hidden" id="txtDonationId">
                <div class="col-12 text-center demo-vertical-spacing">
                    <button class="btn btn-primary me-4" id="btnAproval">Recommand</button>
