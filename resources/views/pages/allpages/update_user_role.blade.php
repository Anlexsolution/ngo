        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="row mt-3">
                            <form id="userRoleForm" action="/updateuserrole" method="POST">
                                @csrf
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                @if (in_array('member', json_decode($userData->permission))) checked @endif value="member"
                                                id="member"
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('addMember', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('viewMember', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageMember', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input " type="checkbox" name="permissions[]"
                                                value="importMember" id="importMember"
                                                @if (in_array('importMember', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-6">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageMemberEdit', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-6">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageMemberDelete', json_decode($userData->permission))) checked @endif>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('division', json_decode($userData->permission))) checked @endif
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('DivisionByVillage', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('divisionByGn', json_decode($userData->permission))) checked @endif>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                @if (in_array('account', json_decode($userData->permission))) checked @endif value="account"
                                                id="account"
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('addAccount', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('viewAccount', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('transferAccount', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('addExpensiveIncome', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('collectionTransfer', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageAccount', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-6">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageAccountEdit', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-6">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageAccountDelete', json_decode($userData->permission))) checked @endif>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                value="loan" id="loan"
                                                @if (in_array('loan', json_decode($userData->permission))) checked @endif
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('addLoan', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('addOldLoan', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageLoanRquest', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('loanProduct', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('loanCalculator', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageLoan', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-6">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageLoanEdit', json_decode($userData->permission))) checked @endif>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('savings', json_decode($userData->permission))) checked @endif
                                        ...
                                        <div class="form-check ms-4" hidden>
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('addSavings', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('viewSavings', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageSavings', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('savingsSettings', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('Withdrawal', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('ImportSavingHistory', json_decode($userData->permission))) checked @endif>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('death', json_decode($userData->permission))) checked @endif
                                        ...
                                        <div class="form-check ms-4" hidden>
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('addDeath', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('viewDeath', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageDeath', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('ImportDeathHistory', json_decode($userData->permission))) checked @endif>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                name="permissions[]" value="deathDonation" id="deathDonation"  @if (in_array('deathDonation', json_decode($userData->permission))) checked @endif
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                name="permissions[]" value="manageDeathDonation"
                                                id="manageDeathDonation"  @if (in_array('manageDeathDonation', json_decode($userData->permission))) checked @endif>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('otherIncome', json_decode($userData->permission))) checked @endif
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('manageIncome', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('importOtherIncome', json_decode($userData->permission))) checked @endif>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('repayment', json_decode($userData->permission))) checked @endif
                                        ...
                                        {{-- <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('directSavings', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('loanRepayment', json_decode($userData->permission))) checked @endif>
                                        ...
                                        {{-- <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('openingBalance', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('collectionDeposit', json_decode($userData->permission))) checked @endif>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('meetings', json_decode($userData->permission))) checked @endif
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('addMeetings', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('viewMeetings', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageMeetings', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-6">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('ManageMeetingsEdit', json_decode($userData->permission))) checked @endif>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('report', json_decode($userData->permission))) checked @endif
                                        ...
                                        {{-- <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('openingBalanceReport', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('memberReport', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('withdrawalReport', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('collectionReport', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('collectionvsdeposit', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input userPermissions" type="checkbox"
                                                ...
                                                @if (in_array('loanReport', json_decode($userData->permission))) checked @endif>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('userManage', json_decode($userData->permission))) checked @endif
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('addUsers', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('manageUsers', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('userRole', json_decode($userData->permission))) checked @endif>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('settings', json_decode($userData->permission))) checked @endif
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('manage', json_decode($userData->permission))) checked @endif>
                                        ...
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" name="permissions[]"
                                                ...
                                                @if (in_array('activityLog', json_decode($userData->permission))) checked @endif>
                                ...
                                <div class="col mt-3 d-flex justify-content-end">
                                    <button class="btn btn-primary" type="submit" value="updaterole">Update
                                        Role</button>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        ...
        function loanCheck(loanCheckBox) {
            toggleSubPermissions(loanCheckBox,
                '#ManageLoanRquest, #addLoan, #loanProduct, #loanCalculator, #ManageLoan, #ManageLoanEdit, #ManageLoanDelete'
            );
        }
        ...
        function repaymentCheck(repaymentCheckBox) {
            toggleSubPermissions(repaymentCheckBox, '#addRepayment, #viewRepayment, #ManageRepayment');
        ...
        function reportCheck(reportCheckBox) {
            toggleSubPermissions(reportCheckBox, '#viewReports');
        }
