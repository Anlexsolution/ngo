        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                @if ($userType == 'superAdmin')
                    @include('pages.allpages.account.manage_account')
                @else
                    @php
                    ...
                    @if (in_array($userType, $userRolesArray))
                        ...
                        @if (in_array('ManageAccount', $usersDataPer) || in_array('addAccount', $usersDataPer) || in_array('viewAccount', $usersDataPer))
                            @include('pages.allpages.account.manage_account')
                        @else
