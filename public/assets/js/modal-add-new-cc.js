...
//CREATE ADD DIVISION FORM - START
let addNewDivisionModal = document.getElementById('addNewDivisionModal');
addNewDivisionModal.addEventListener('show.bs.modal', function (event) {
  initCleave();
});

    // Credit card form validation
    FormValidation.formValidation(document.getElementById('addNewDivisionForm'), {
      fields: {
        divisionName: {
          validators: {
            notEmpty: {
