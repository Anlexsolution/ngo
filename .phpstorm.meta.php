...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Applications/XAMPP/xamppfiles/htdocs/anlex/ngoproject.com/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Applications/XAMPP/xamppfiles/htdocs/anlex/ngoproject.com/public/storage','logging.default','logging.deprecations.channel',
...
'services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.recaptcha.site_key','services.recaptcha.secret_key',
...
'web','api',);
        registerArgumentsSet('routes', 'login','e-login','otp_verify','assign_division','update_user',
'profile_view','update_user_role','assign_permssion_update','enable_user','disable_user',
'delete_user',
'division_details','village_details','smallgroup_details','view_member','update_member','show_member','delete_member','filter_members_by_division','filter_members_by_village','view_account_details','view_saving_history',
'view_savings_histories','view_loan_request','loan_follower',
'view_loan_approval','view_loan_details','direct_saving_receipt','repayment_receipt','view_death_history','view_withdrawal_request','view_withdrawal_history',);
        registerArgumentsSet('views', 
'auth.login','auth.login_member','auth.otp_verify','auth.register','pages.401page',
'pages.add_division_per','pages.add_member_per','pages.add_smallgroup_per','pages.add_users','pages.add_vilage_per',
'pages.admin.add_user_role','pages.admin.create_user_role','pages.allpages.401','pages.allpages.account.create_account','pages.allpages.account.manage_account',
'pages.allpages.account.view_account_details','pages.allpages.add_division','pages.allpages.add_smallgroup','pages.allpages.add_vilage','pages.allpages.assign_division',
'pages.allpages.collection.collection_deposit','pages.allpages.collection.collection_vs_deposit_reports','pages.allpages.create-users','pages.allpages.create_div','pages.allpages.create_gn_division',
'pages.allpages.create_member','pages.allpages.death_manage','pages.allpages.directsavings.direct_savings','pages.allpages.divisionbyvillage.division_details','pages.allpages.divisionbyvillage.smallgroup_details',
'pages.allpages.divisionbyvillage.village_details','pages.allpages.gndivision.create_smallgroup_by_gn','pages.allpages.loan.create_loan','pages.allpages.loan.create_loan_product','pages.allpages.loan.create_old_loan',
'pages.allpages.loan.list_of_loan','pages.allpages.loan.loan_details_view','pages.allpages.loan.loan_follower','pages.allpages.loan.manage_loan_product','pages.allpages.loan.manage_loan_request',
'pages.allpages.loan.repayment_details','pages.allpages.loan.repayment_schedule_view','pages.allpages.loan.view_loan_approval','pages.allpages.loan.view_loan_details','pages.allpages.loan.view_loan_request',
'pages.allpages.loanrepayment.loan_repayment','pages.allpages.manage_division','pages.allpages.manage_member','pages.allpages.manage_savings','pages.allpages.manage_settings',
'pages.allpages.manage_users','pages.allpages.memberlogin.show_member','pages.allpages.memberpages.death_details','pages.allpages.memberpages.documents_details','pages.allpages.memberpages.loan_details',
'pages.allpages.memberpages.login_details','pages.allpages.memberpages.meetings_details','pages.allpages.memberpages.notes_details','pages.allpages.memberpages.personal_details','pages.allpages.memberpages.saving_details',
'pages.allpages.memberpages.view_savings_histories','pages.allpages.openingbalance.opening_balance','pages.allpages.otherincome.manage_other_incomes','pages.allpages.profile_view','pages.allpages.reports.collection_reports',
'pages.allpages.reports.manage_reports','pages.allpages.reports.member_report','pages.allpages.reports.opening_balance_report','pages.allpages.reports.view_withdrawal_history','pages.allpages.reports.withrawal_approve_reports',
'pages.allpages.settings.create_profession','pages.allpages.settings.manage_account_settings','pages.allpages.settings.manage_activitylog','pages.allpages.settings.manage_approval_settings','pages.allpages.settings.manage_loan_purpose',
'pages.allpages.settings.manage_profession','pages.allpages.update_member','pages.allpages.update_user','pages.allpages.update_user_role','pages.allpages.users.assign_permssion_update',
'pages.allpages.view_death_history','pages.allpages.view_member','pages.allpages.view_saving_history','pages.allpages.withdrawal.view_withdrawal_request','pages.assign_division_per',
'pages.create_division','pages.create_gn_division_per','pages.create_user_role_per','pages.dashboard','pages.dashboard.member_dashboard',
'pages.dashboard.superadmindashboard','pages.death_manage_per','pages.manage_division_per','pages.manage_member_per','pages.manage_savings_per',
'pages.manage_settings_per','pages.manage_user_role_per','pages.manage_users_per','pages.permission.account.create_account_per','pages.permission.account.manage_account_per',
'pages.permission.account.view_account_details_per','pages.permission.collection.collection_deposit_per','pages.permission.collection.collection_vs_deposit_reports_per','pages.permission.directsavings.direct_savings_per','pages.permission.divisionbyvillage.division_details_per',
'pages.permission.divisionbyvillage.smallgroup_details_per','pages.permission.divisionbyvillage.village_details_per','pages.permission.gndivision.create_smallgroup_by_gn_per','pages.permission.loan.create_loan_per','pages.permission.loan.create_loan_product_per',
'pages.permission.loan.create_old_loan_per','pages.permission.loan.list_of_loan_per','pages.permission.loan.loan_follower_per','pages.permission.loan.manage_loan_product_per','pages.permission.loan.manage_loan_request_per',
'pages.permission.loan.view_loan_approval_per','pages.permission.loan.view_loan_details_per','pages.permission.loan.view_loan_request_per','pages.permission.loanrepayment.loan_repayment_per','pages.permission.memberlogin.show_member_per',
'pages.permission.openingbalance.opening_balance_per','pages.permission.otherincome.manage_other_incomes_per','pages.permission.reports.collection_reports_per','pages.permission.reports.manage_reports_per','pages.permission.reports.member_report_per',
'pages.permission.reports.opening_balance_report_per','pages.permission.reports.view_withdrawal_history_per','pages.permission.reports.withrawal_approve_reports_per','pages.permission.settings.create_profession_per','pages.permission.settings.manage_account_settings_per',
'pages.permission.settings.manage_activitylog_per','pages.permission.settings.manage_approval_settings_per','pages.permission.settings.manage_loan_purpose_per','pages.permission.settings.manage_profession_per','pages.permission.users.assign_permssion_update_per',
'pages.permission.withdrawal.view_withdrawal_request_per','pages.profile_view_per','pages.update_member_per','pages.update_user_per','pages.update_userrole_per',
'pages.user_role','pages.view_death_history_per','pages.view_member_per','pages.view_member_sav_his_per','pages.view_saving_history_per',
'receipts.direct_saving_receipts','receipts.repayment_recipet','source.footer','source.header','source.inlcude.loader',
'source.inlcude.member_sidebar','source.inlcude.superadminsidebar','source.inlcude.superadmintopbar','source.pagefooter','laravel-exceptions-renderer::components.card',
...
'DB_PASSWORD','GOOGLE_MAPS_API_KEY','RECAPTCHA_SITE_KEY','RECAPTCHA_SECRET_KEY','SESSION_DRIVER',
