...
Route::post('/updateGnDivisiondata', [manage_division_controller::class, 'updateGnDivisiondata'])->middleware('auth');
Route::post('/updateSmallGroup', [manage_division_controller::class, 'updateSmallGroup'])->middleware('auth');
